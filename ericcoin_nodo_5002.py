...
class Blockchain:
    ...
    def add_persona(self, nombre, domicilio, municipio, estado, curp, fecha_nacimiento):
        self.personas.append({'nombre': nombre,
                              'domicilio': domicilio,
                              'municipio': municipio,
                              'estado': estado,
                              'curp': curp,
...
def add_persona():
    if request.method == 'POST':
        ...
        blockchain.add_persona(nombre, domicilio, municipio, estado, curp, fecha_nacimiento)
        return render_template('Inicio.html')
...
def connect_node():
    ...
    for node in nodes:
        blockchain.add_node(node)
    response = {
        'message': 'Todos los nodos estan ahora conectados. El Blockchain contiene los siguientes nodos:',
